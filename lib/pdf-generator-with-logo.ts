...
// Base64 encoded Sr. Food Safety logo (you would replace this with the actual base64 of your logo)
const SR_FOOD_SAFETY_LOGO_BASE64 =
...
export async function generateRecipePDF(recipe: Recipe): Promise<Blob> {
  ...
  // Add Sr. Food Safety logo and text
  ...
  pdf.setTextColor(46, 125, 50) // Green color for SAFETY
  pdf.setFontSize(16)
  pdf.text("SAFETY", 20, 35)

  // Title
  pdf.setTextColor(255, 255, 255)
  pdf.setFontSize(18)
  pdf.setFont("helvetica", "bold")
  pdf.text("FICHA TÉCNICA DE RECEITA", 100, 30)
